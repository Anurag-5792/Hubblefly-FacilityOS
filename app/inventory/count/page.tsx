...
function CountContent() {
  ...
  return (
    <main className="workflow-page">
      <header className="scan-header"><div><Link className="back-link" href="/inventory/scan">← Scanner</Link><p className="eyebrow">Inventory workflow</p><h1>Physical count</h1><p className="lead">Capture verified physical quantity without silently changing ERPNext. Reconciliation and posting remain separate approval steps.</p></div><span className="preview-badge">Physical truth first</span></header>
...
export default function CountPage() {
  return <Suspense fallback={<main className="workflow-page"><div className="panel">Loading count workflow…</div></main>}><CountContent /></Suspense>;
}
